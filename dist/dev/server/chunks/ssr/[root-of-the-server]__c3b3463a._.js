...
async function generateMetadata({ params }) {
    ...
    if (!project) return {};
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio_v3$2f$lib$2f$metadata$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createMetadata"])({
        title: `${project.title} | Portfolio`,
        description: project.description,
        images: [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio_v3$2f$lib$2f$metadata$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["absoluteUrl"])(project.coverImage)
        ],
        path: `/projects/${slug}`
    });
}
